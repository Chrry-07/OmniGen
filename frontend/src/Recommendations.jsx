...
const PARAM_ICONS = {
  temperature: <Thermometer size={18} strokeWidth={1.6} className="text-orange-400" />,
  pressure: <Gauge size={18} strokeWidth={1.6} className="text-blue-400" />,
  motorSpeed: <Zap size={18} strokeWidth={1.6} className="text-yellow-400" />,
  flowRate: <Wind size={18} strokeWidth={1.6} className="text-cyan-400" />,
};
